...
Incident response kit: severity model, roles, communication templates, timeline, and blameless postmortem template.

## Templates

| File | Use |
|------|-----|
| `templates/severity.md` | SEV model |
| `templates/incident_channel.md` | War room checklist |
| `templates/status_update.md` | Stakeholder update |
| `templates/postmortem.md` | Blameless postmortem |
| `templates/timeline.md` | Timeline log |
| `docs/ONCALL.md` | On-call expectations |

Copy templates into your wiki / Notion / PagerDuty runbook store and adapt.
